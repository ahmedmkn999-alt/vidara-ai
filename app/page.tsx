    ...
    <div className="text-white min-h-screen">
      <nav className="p-6 flex justify-between items-center sticky top-0 bg-[#0b0f19]/80 backdrop-blur-md z-50">
        ...
        <div className="flex gap-4">
          <Link href="/api/auth/signin" className="px-6 py-2 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 font-bold shadow-xl hover:scale-105 transition">دخول / سجل بجوجل</Link>
        </div>
      </nav>

      <section className="py-20 text-center">
        <h1 className="text-5xl font-extrabold mb-6 italic">ازاي تشغل الموقع؟</h1>
        <div className="max-w-4xl mx-auto bg-gray-800 p-4 rounded-3xl border border-gray-700 shadow-2xl aspect-video flex items-center justify-center text-gray-500">
           [فيديو تعليمي]
        </div>
      </section>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {plans.map((plan, i) => (
            <div key={i} className="bg-[#161b2a] rounded-3xl p-8 border border-gray-800 text-center hover:border-purple-500 transition-all relative overflow-hidden">
